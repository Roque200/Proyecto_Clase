    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="btn-group" role="group">
                <a href="docente.php?seccion=anuncios&action=create" class="btn btn-success">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="docente.php?seccion=anuncios&action=update&id=<?php echo $anuncio['id_anuncio_PK']; ?>" 
                                       class="btn btn-warning">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a href="docente.php?seccion=anuncios&action=delete&id=<?php echo $anuncio['id_anuncio_PK']; ?>" 
