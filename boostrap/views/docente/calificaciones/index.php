<div class="container mt-4">
    <div class="row mb-4">
        <div class="col-12">
            <h2><i class="bi bi-clipboard-check"></i> Gestión de Calificaciones - <?php echo htmlspecialchars($_SESSION['docente_carrera']); ?></h2>
    ...
    <div class="alert alert-info">
        <i class="bi bi-info-circle"></i> Mostrando únicamente las calificaciones de estudiantes de 
    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="btn-group" role="group">
                <a href="docente.php?seccion=calificaciones&action=create" class="btn btn-success">
    ...
    <div class="card">
        <div class="card-header bg-success text-white">
            <h5 class="mb-0">Lista de Calificaciones - <?php echo htmlspecialchars($_SESSION['docente_carrera']); ?></h5>
        </div>
        <div class="card-body">
            <?php if (count($data) > 0): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="docente.php?seccion=calificaciones&action=update&id=<?php echo $calificacion['id_calificacion_PK']; ?>" 
            ...
            <?php else: ?>
            <div class="alert alert-info">
                <i class="bi bi-info-circle"></i> No hay calificaciones registradas para estudiantes de 
                <strong><?php echo htmlspecialchars($_SESSION['docente_carrera']); ?></strong>.
            </div>
            <?php endif; ?>
        </div>
