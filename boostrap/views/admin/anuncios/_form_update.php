        ...
        <div class="col-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="admin.php?seccion=anuncios" class="text-decoration-none">Anuncios</a></li>
    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="admin.php?seccion=anuncios&action=update&id=<?php echo $data['id_anuncio_PK']; ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="contenido" name="contenido" 
                                      rows="8" required><?php echo htmlspecialchars($data['contenido']); ?></textarea>
                        </div>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="admin.php?seccion=anuncios" class="btn btn-secondary">
